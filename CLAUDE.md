...
| | 09 model selection | LRT/BIC, covsearch, modelsearch, ruvsearch, iivsearch, iovsearch, `ferx_globalsearch()`, `ferx_amd()`/`ferx_amd_plan()`, search configs |
...
| | 23 adaptive dosing, 24 experimental | `ferx_simulate_adaptive()`; SDE, `[covariate_nn]`, parameter priors (inline `prior()`, `[priors]`) |
