...
The last three change the scale the theta is estimated and reported on, which @sec-first-fit covers. The first two do not, and are the forms this chapter uses.
