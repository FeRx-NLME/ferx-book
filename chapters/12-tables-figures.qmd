...
`[output]` lists individual parameters, covariates or other names to add to `sdtab` (ferx-core [output](https://ferx-nlme.github.io/ferx-core/model-file/output.html) page).
