...
Diagnostic codes are stable identifiers: `E_*` for errors, `W_*` for warnings. The full list is on the ferx-core [check report](https://ferx-nlme.github.io/ferx-core/file-formats/check-report.html) page.
